 ...
 *	Creative Item
 *	www.picolime.com
 *	http://codecanyon.net/user/PicoLime Systems
 */
...
class Install extends CI_Controller {
	...
	function verify_purchase()
	{
		...
		$url = "http://marketplace.envato.com/api/v3/PicoLime Systems/t3593ia0r3xbxcx85b4zve2j53y7zzrr/verify-purchase:".$purchase_code.".json";
